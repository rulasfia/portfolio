...
export default function About() {
  return (
    <>
      <main className="container mx-auto min-h-screen px-36">
        ...
        <section className="grid grid-cols-1 justify-between gap-4 border-b border-primary-700 py-8 lg:grid-cols-3">
